...
|---|---|---|---|
| orchestrator | claude-sonnet-4.6 | medium | default |
| quick | claude-haiku-4.5 | low | default |
| default-development | claude-sonnet-4.6 | medium | default |
| agentic-implementation | gpt-5.3-codex | high | default |
| deep-reasoning | claude-opus-4.8 | high | long_context |
| review | claude-sonnet-4.6 | medium | default |
| visual-ui | claude-sonnet-4.6 | medium | default |
| mechanical | claude-haiku-4.5 | low | default |
| triage | claude-sonnet-4.6 | low | default |
