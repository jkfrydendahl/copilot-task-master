...
Review all changed files against the review criteria defined in the Code Review Standards instruction (loaded with your instructions):
...
> For deeper review coverage with multiple AI models, run the `/review` command with the models listed in the shared `config/review-models.md`.
